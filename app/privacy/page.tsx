...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen px-6 py-16 pb-24 relative" style={{ background: "#f8f6ff" }}>
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full blur-3xl opacity-15" style={{ background: "#c8d8ff", transform: "translate(30%,-30%)" }} />
      </div>
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-2" style={{ letterSpacing: "-0.03em", color: "#0d1525" }}>Privacy Policy</h1>
        <p className="text-sm mb-10" style={{ color: "rgba(0,0,0,0.4)" }}>Last updated: June 2026</p>

        <div className="space-y-8 text-sm leading-relaxed" style={{ color: "rgba(0,0,0,0.6)" }}>
          <section>
            <h2 className="text-base font-semibold mb-2" style={{ color: "#0d1525" }}>1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-semibold mb-2" style={{ color: "#0d1525" }}>2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-base font-semibold mb-2" style={{ color: "#0d1525" }}>3. Photos &amp; Videos</h2>
          ...
          <section>
            <h2 className="text-base font-semibold mb-2" style={{ color: "#0d1525" }}>4. Google Sign-In</h2>
          ...
          <section>
            <h2 className="text-base font-semibold mb-2" style={{ color: "#0d1525" }}>5. Data Storage</h2>
          ...
          <section>
            <h2 className="text-base font-semibold mb-2" style={{ color: "#0d1525" }}>6. Your Rights</h2>
          ...
          <section>
            <h2 className="text-base font-semibold mb-2" style={{ color: "#0d1525" }}>7. Contact</h2>
            <p>For any privacy concerns, please reach out to us:</p>
            <div className="mt-2 p-4 rounded-2xl" style={{ background: "rgba(255,255,255,0.85)", border: "1px solid rgba(0,0,0,0.08)", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
              <p className="font-medium" style={{ color: "#0d1525" }}>Subhas &amp; Sanchita Dey</p>
              <a href="tel:4252896422" className="hover:underline" style={{ color: "#8A6E00" }}>(425) 289-6422</a>
            </div>
          </section>
        </div>
      </div>

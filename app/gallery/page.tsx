      ...
      <main className="flex-1 px-4 md:px-8 py-8 pb-24 max-w-6xl mx-auto w-full">
        ...
        <div className="mb-8 p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.85)", border: "1px solid rgba(0,0,0,0.08)", boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
          ...
          {status === "unauthenticated" ? (
            <div className="py-4">
              <p className="text-sm mb-3" style={{ color: "rgba(0,0,0,0.45)" }}>Sign in with Google to share photos and videos</p>
        ...
        {status === "unauthenticated" ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-sm mb-6" style={{ color: "rgba(0,0,0,0.4)" }}>Photos and videos are visible to signed-in guests</p>
            <button onClick={() => signIn("google")}

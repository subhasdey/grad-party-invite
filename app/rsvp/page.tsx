...
export default function RSVPPage() {
  ...
  if (pageStatus === "success") {
    return (
      <main className="min-h-screen flex items-center justify-center px-6" style={{ background: "#f5f5f7" }}>
        <div className="max-w-sm w-full text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/chat" className="py-3.5 rounded-2xl text-sm font-medium transition-all text-center" style={{ background: "#f5f5f7", color: "rgba(0,0,0,0.6)", border: "1px solid rgba(0,0,0,0.08)" }}>Join Party Chat</Link>
  ...
  return (
    <main className="min-h-screen px-4 py-12" style={{ background: "#f5f5f7" }}>
        ...
        {status === "unauthenticated" && (
          <div className="mb-6 p-5 rounded-2xl text-center" style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)" }}>
            ...
            <button onClick={() => signIn("google")}
              ...
              style={{ background: "#f5f5f7", color: "#1d1d1f", border: "1px solid rgba(0,0,0,0.1)" }}>
